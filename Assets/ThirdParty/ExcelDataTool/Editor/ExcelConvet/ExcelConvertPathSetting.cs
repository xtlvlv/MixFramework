...
namespace XFramework.ExcelData.Editor
{
    public static class ExcelConvertPathSetting
    {
        ...
        /// 插件路径
        /// </summary>
        public const string PluginPath = "Assets/ThirdParty/ExcelDataTool/";
        ...
        /// 代码生成路径
        /// </summary>
        public const string GenerateCSFilePath = "/Assets/ScriptsHotfix/Manager/ExcelDataManager/ExcelData/";
